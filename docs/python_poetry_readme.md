### Python+Poetry Snippets if required
...
export PATH=/Users/<user>/.pyenv/versions/<python_version>/envs/<env>/bin:$PATH
source /Users/<user>/.pyenv/versions/<python_version>/envs/<env>/bin/activate
